...
chao1
ggsave("../figures/chao1.png", plot=last_plot(), device=NULL, path=NULL, scale=1, width=8, height=5, dpi=300, limitsize=TRUE)
```
  ...
  labs(x = "Social Status", y = "Shannon Diversity Index (H')") + 
    theme(strip.text.x = element_text(size=14, face="italic"), strip.text.y =   
          ...
          scale_x_discrete(breaks=c("dominant", "subordinate", "communal", "isolate"),
                           labels=c("dominant", "subordinate", "communal", "isolate"))
shannon
ggsave("../figures/shannon.png", plot=last_plot(), device=NULL, path=NULL, scale=1, width=8, height=5, dpi=300, limitsize=TRUE)
```
  ...
  labs(x = "Social Status", y = "Simpson's Evenness") + 
    theme(strip.text.x = element_text(size=14, face="italic"), strip.text.y =   
          ...
          scale_x_discrete(breaks=c("dominant", "subordinate", "communal", "isolate"),
                           labels=c("dominant", "subordinate", "communal", "isolate"))
simpeven
ggsave("../figures/simpeven.png", plot=last_plot(), device=NULL, path=NULL, scale=1, width=8, height=5, dpi=300, limitsize=TRUE)
```
# Combine diversity plots
```{r combine diversity, echo=TRUE}
#combining plots
#p1 <- chao1
#p2 <- shannon
#p3 <- simpeven
...
ggsave("../figures/zf_PCoAordination.png", plot=last_plot(), device=NULL, path=NULL, scale=1, width=7, height=5, dpi=300, limitsize=TRUE)
```
...
zebrafish_genus_v2 <- subset(zebrafish_genus, Social.Status == "Dominant" | Social.Status == "Subordinate" | Social.Status == "Communal" | Social.Status == "Isolate")
...
ggsave("../figures/genuscomp.png", plot=last_plot(), device=NULL, path=NULL, scale=1, width=7, height=5, dpi=300, limitsize=TRUE)
```
